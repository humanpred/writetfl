...
``` r
.rtables_content_height(pg_width, pg_height, dots, page_num, annot)
```
...
- annot:
  ...
  [`.extract_rtables_annotations()`](https://humanpred.github.io/writetfl/reference/dot-extract_rtables_annotations.md).
