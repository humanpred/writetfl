...
``` r
.flextable_content_height(pg_width, pg_height, dots, page_num, annot)
```
...
- annot:
  ...
  [`.extract_flextable_annotations()`](https://humanpred.github.io/writetfl/reference/dot-extract_flextable_annotations.md).
