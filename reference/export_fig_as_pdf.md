...
- x:
  ...
  A single `ggplot` object, or a named list of page specifications. Each
  page specification is a list with a required `figure` element (a
  `ggplot` object) and optional elements corresponding to the text
  arguments of
  [`export_figpage_to_pdf()`](https://humanpred.github.io/writetfl/reference/export_figpage_to_pdf.md):
