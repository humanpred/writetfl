...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment  = "#>",
  eval     = FALSE   # all examples write PDFs; set eval=TRUE to run locally
)
```
...
`preview = TRUE` calls `grid.newpage()` and draws to whatever device is already
open, without opening or closing a PDF. This is useful for interactive
inspection in RStudio or Positron.
