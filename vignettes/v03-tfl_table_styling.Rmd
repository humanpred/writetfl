...
```{r span-basic, fig.width = 11, fig.height = 4, out.width = "100%"}
resp <- data.frame(
  subgroup = c("All patients", "Age < 65", "Age ≥ 65"),
...
```{r span-uneven, fig.width = 11, fig.height = 4, out.width = "100%"}
...
```{r span-escape, fig.width = 11, fig.height = 4, out.width = "100%"}
