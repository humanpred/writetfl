...
See the *Exporting TFLs to PDF with writetfl* vignette for a full reference of
all `export_tfl()` layout arguments, including typography (`gp`), padding, rules,
...
| `gp` | `gpar()` | Typography for headers and body cells |
