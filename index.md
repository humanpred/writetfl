...
data-frame tables, and other grid content with the precise, composable
...
Grid grobs (e.g. from `gt` or `gridExtra`) are also accepted as
`content`, so you can mix figures and tables in one PDF:
